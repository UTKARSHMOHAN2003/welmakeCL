      ...
      >
        ...
        >
          <div className="px-6 py-4 space-y-4">
            ...
            <a
              href="/order"
              className="sm:hidden block text-blue-800 font-bold text-lg py-2 pl-2 border-l-2 border-transparent hover:border-blue-800 hover:text-blue-600 transition-all duration-300"
            >
              Order Now
            </a>
          </div>
